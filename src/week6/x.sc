...
object x {
  ...
  // Testing it works
  translate("7225247386")                         //> res0: Set[String] = Set(rack-ah-re-to, sack-ah-re-to, pack-ah-re-to, Scala-
                                                  //| ire-to, sack-bird-to, Scala-is-fun, rack-air-fun, rack-bird-to, sack-air-fu
                                                  //| n, pack-bird-to, pack-air-fun)
