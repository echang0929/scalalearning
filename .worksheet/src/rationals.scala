...
object rationals {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(63); 
  ...
  val z = new Rational(3,2);System.out.println("""z  : Rational = """ + $show(z ));$skip(10); val res$0 = 
  ...
  x + y;System.out.println("""res2: Rational = """ + $show(res$2));$skip(12); val res$3 = 
  x - y - z;System.out.println("""res3: Rational = """ + $show(res$3));$skip(8); val res$4 = 
  y + y;System.out.println("""res4: Rational = """ + $show(res$4));$skip(14); val res$5 = 

	(x + y) * z;System.out.println("""res5: Rational = """ + $show(res$5));$skip(12); val res$6 = 
	  
  x < y;System.out.println("""res6: Boolean = """ + $show(res$6));$skip(10); val res$7 = 
  x max y;System.out.println("""res7: Rational = """ + $show(res$7));$skip(21); val res$8 = 
